...
Revision ID: 963bb08384e3
Revises: 17f39e3cb23b
Create Date: 2024-03-27 13:26:23.874270
...
revision = '963bb08384e3'
down_revision = '17f39e3cb23b'
branch_labels = None
depends_on = None
...
def downgrade():
    ...
    sa.Column('sex', mysql.VARCHAR(length=20), nullable=False),
